...
class EventLikersListAdapter : ListAdapter<User, EventLikersListAdapter.EventLikersViewHolder>(EventLikersDiffCallback()) {
    ...
    class EventLikersDiffCallback : DiffUtil.ItemCallback<User>() {
